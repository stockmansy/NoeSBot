...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_resource__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_tabs_component__ = __webpack_require__(334);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('tabs', __WEBPACK_IMPORTED_MODULE_2_vue_tabs_component__["Tabs"]);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('tab', __WEBPACK_IMPORTED_MODULE_2_vue_tabs_component__["Tab"]);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_resource__["a" /* default */]);

var featureapp = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#features',
    created() {
    ...
    components: { Tab: __WEBPACK_IMPORTED_MODULE_2_vue_tabs_component__["Tab"], Tabs: __WEBPACK_IMPORTED_MODULE_2_vue_tabs_component__["Tabs"] },
    methods: {
        refreshFeatures(resource) {
            __WEBPACK_IMPORTED_MODULE_0_vue___default.a.http.get('/api/Feature').then(response => {
