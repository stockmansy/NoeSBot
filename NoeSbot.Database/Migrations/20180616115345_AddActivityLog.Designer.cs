...
namespace NoeSbot.Database.Migrations
{
    ...
    [Migration("20180616115345_AddActivityLog")]
    partial class AddActivityLog
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("NoeSbot.Database.Models.ActivityLog", b =>
                {
                    ...
                    b.ToTable("ActivityLogEntities");
                });

            modelBuilder.Entity("NoeSbot.Database.Models.ActivityLog+ActivityLogItem", b =>
                {
                    b.Property<int>("ActivityLogItemId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("ActivityLogItemId");

                    b.HasIndex("ActivityLogId");

                    b.ToTable("ActivityLogItem");
                });
            ...
            modelBuilder.Entity("NoeSbot.Database.Models.CustomCommand", b =>
                {
                    ...
                    b.ToTable("CustomCommandEntities");
                });
            ...
            modelBuilder.Entity("NoeSbot.Database.Models.SerializedItem", b =>
                {
                    ...
                    b.ToTable("SerializedItemEntities");
                });

            modelBuilder.Entity("NoeSbot.Database.Models.ActivityLog+ActivityLogItem", b =>
                {
                    b.HasOne("NoeSbot.Database.Models.ActivityLog")
                        .WithMany("Logs")
