...
namespace NoeSbot.Modules
{
    ...
    public class MessageTriggerModule : ModuleBase
    {
        ...
        public async Task AddTrigger()
        {
            ...
            await ReplyAsync("", false, CommonHelper.GetHelp(Labels.MessageTrigger_AddTrigger_Command, GlobalConfig.GetGuildConfig(Context.Guild.Id).Prefixes, user.GetColor()));
        }
        ...
        {
            var user = Context.User as SocketGuildUser;
            await ReplyAsync("", false, CommonHelper.GetHelp(Labels.MessageTrigger_DeleteTrigger_Command, GlobalConfig.GetGuildConfig(Context.Guild.Id).Prefixes, user.GetColor()));
        }
